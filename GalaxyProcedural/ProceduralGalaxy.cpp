...
public:
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
		...
		if (bStarSelected)
		{
			...
			FillCircle(vBody.x, vBody.y,(int)(star.starDiameter * 1.375), star.starColour);			 
			...
			for (auto& planet : star.vPlanets)
			{
				...
				FillCircle(vBody.x, vBody.y,(int)(planet.diameter * 1.0), olc::RED);
				...
				{
					vMoon.y += moon;
					FillCircle(vMoon.x, vMoon.y, (int)(moon * 1.0), olc::GREY);
					vMoon.y += moon + 10;
				}
